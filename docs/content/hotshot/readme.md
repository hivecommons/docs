> **Synced from hotshot.** This page is pulled from [hivecommons/hotshot@main](https://github.com/hivecommons/hotshot/blob/main/README.md) during the docs build. Edit the canonical source in the hotshot repository.
...
| **Linux** | Shell script (X11 & Wayland) | Hotkey you bind in your DE (e.g. Ctrl+Shift+Print) | `linux/install.sh` | [linux/README.md](/docs/hotshot/linux) |
| **Windows** | PowerShell script (+ optional AutoHotkey v2) | Global hotkey (default Ctrl+Alt+H) → Snipping overlay | `windows\install.ps1` | [windows/README.md](/docs/hotshot/windows) |
...
Apache-2.0 — see [LICENSE](https://github.com/hivecommons/hotshot/blob/main/LICENSE).
