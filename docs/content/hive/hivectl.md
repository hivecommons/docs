> **Synced from Hive.** This page is pulled from [hivecommons/hive@v5](https://github.com/hivecommons/hive/blob/v5/src/docs/hivectl.md) during the docs build. Edit the canonical source in the Hive repository.
...
[`src/docs/design/tui.md`](https://github.com/hivecommons/hive/blob/v5/src/docs/design/tui.md).
...
[`src/docs/design/tui.tape`](https://github.com/hivecommons/hive/blob/v5/src/docs/design/tui.tape) — launch, the four populated
