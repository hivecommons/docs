> **Synced from Hive.** This page is pulled from [hivecommons/hive@v5](https://github.com/hivecommons/hive/blob/v5/src/docs/security-threat-model.md) during the docs build. Edit the canonical source in the Hive repository.
...
discussions. Follow the repository [Security Policy](https://github.com/hivecommons/hive/blob/v5/SECURITY.md): use
