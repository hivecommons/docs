> **Synced from Hive.** This page is pulled from [hivecommons/hive@v4](https://github.com/hivecommons/hive/blob/v4/src/docs/contributor-relay.md) during the docs build. Edit the canonical source in the Hive repository.
...
- Every contributor has a **trust tier** with per-tier rate limits. See [Contributor trust tiers and delegated agent roles](https://github.com/hivecommons/hive/blob/v4/src/docs/contributor-trust-and-roles.md).
...
[sandbox-isolation.md](https://github.com/hivecommons/hive/blob/v4/src/docs/sandbox-isolation.md)'s per-backend confinement matrix
...
The hive may override the request with an owner-assigned role. See [Contributor trust tiers and delegated agent roles](https://github.com/hivecommons/hive/blob/v4/src/docs/contributor-trust-and-roles.md) for tier, grant, and allow-list requirements.
