> **Synced from Hive.** This page is pulled from [hivecommons/hive@v4](https://github.com/hivecommons/hive/blob/v4/src/docs/landscape.md) during the docs build. Edit the canonical source in the Hive repository.
