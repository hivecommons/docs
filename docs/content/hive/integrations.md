...
## ![Claude Code logo](/integrations/claude.svg) Claude Code [#claude-code]
...
## ![GitHub Copilot CLI logo](/integrations/githubcopilot.svg) GitHub Copilot CLI [#github-copilot-cli]
...
## ![Goose logo](/integrations/goose.png) Goose [#goose]
...
## ![OpenAI Codex CLI logo](/integrations/openai.svg) OpenAI Codex CLI [#openai-codex-cli]
...
## ![Pi logo](/integrations/pi.png) Pi [#pi]
...
## ![IBM Bob logo](/integrations/ibm.svg) IBM Bob [#ibm-bob]
...
## ![Aider logo](/integrations/aider.png) Aider [#aider]
...
## ![Gemini CLI logo](/integrations/googlegemini.svg) Gemini CLI [#gemini-cli]
...
## ![Google Antigravity CLI logo](/integrations/google.svg) Google Antigravity CLI [#google-antigravity-cli]
...
## ![OpenCode logo](/integrations/opencode.svg) OpenCode [#opencode]
...
## ![Kilo Code logo](/integrations/kilo.png) Kilo Code [#kilo-code]
...
## ![Muse Code logo](/integrations/meta.svg) Muse Code [#muse-code]
...
## ![vLLM logo](/integrations/vllm.png) vLLM [#vllm]
...
## ![llm-d logo](/integrations/llm-d.png) llm-d [#llm-d]
...
## ![LiteLLM logo](/integrations/litellm.png) LiteLLM [#litellm]
...
## ![IBM watsonx.ai logo](/integrations/ibm.svg) IBM watsonx.ai [#ibm-watsonx-ai]
...
## ![OpenRouter logo](/integrations/openrouter.svg) OpenRouter [#openrouter]
...
## ![Anthropic logo](/integrations/anthropic.svg) Anthropic [#anthropic]
...
## ![OpenAI logo](/integrations/openai.svg) OpenAI [#openai]
...
## ![DeepSeek logo](/integrations/deepseek.svg) DeepSeek [#deepseek]
