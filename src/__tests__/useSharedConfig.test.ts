...
const mockConfig: SharedConfig = {
  ...
  editBaseUrls: {
    kubestellar: 'https://github.com/hivecommons/docs/edit/main/docs/content',
    a2a: 'https://github.com/hivecommons/docs/edit/main/docs/content/a2a',
  },
...
describe('getEditUrl', () => {
  it('constructs edit URL for known project', () => {
    ...
    expect(url).toBe(
      'https://github.com/hivecommons/docs/edit/main/docs/content/getting-started/install.md'
    )
  })
...
describe('getSurveyUrl', () => {
  ...
  it('returns fallback when config is null', () => {
    expect(getSurveyUrl(null)).toBe('https://docs.hivecommons.dev/survey')
  })

  it('returns fallback when surveyUrl is undefined', () => {
    const configWithout = { ...mockConfig, surveyUrl: undefined }
    expect(getSurveyUrl(configWithout)).toBe('https://docs.hivecommons.dev/survey')
  })
})
